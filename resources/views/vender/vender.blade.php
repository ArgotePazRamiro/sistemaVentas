                        ...
                        <div class="col-6">
                            <form action="{{ route('terminarOCancelarVenta') }}" method="POST">
                                    ...
                                    <select class="form-select border-warning form-select-lg mb-0"
                                        ...
                                        @foreach ($bancos as $banco)
                                            <option value="{{ $banco->id }}">
                                                {{ $banco->nombre }}---{{ $banco->numeroCuenta }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input autocomplete="off" class="form-control border-1 border-dark bg-light shadow-sm"
                                        type="text" name="codigo" id="codigo" placeholder="">
                                </div>
                        </div>
                            ...
                            <div class="row justify-content-start">
                                <div class="col-6">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input autocomplete="off"
                                                class="form-control border-1 border-success bg-light shadow-sm" type="text"
                                                name="efectivoD" id="efectivoD" placeholder="Dolar $">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <br>
                                            <h5>TRANSFERENCIA $</h5>
                                            <input autocomplete="off"
                                                class="form-control border-1 border-success bg-light shadow-sm" type="text"
                                                name="transferenciaD" id="transferenciaD" placeholder="Dolar $">
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input autocomplete="off"
                                                class="form-control border-1 border-success bg-light shadow-sm" type="text"
                                                name="tarjetaD" id="tarjetaD" placeholder="Dolar $">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <br>
                                            ...
                                            <input autocomplete="off"
                                                class="form-control border-1 border-success bg-light shadow-sm" type="text"
                                                name="depositoD" id="depositoD" placeholder="Dolar $">
                                        </div>
                                ...
                                <div class="col-6">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input autocomplete="off"
                                                ...
                                                name="efectivo" id="efectivo" placeholder="Bolivianos Bs.">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <br>
                                            ...
                                            <input autocomplete="off"
                                                class="form-control border-1 border-info bg-light shadow-sm" type="text"
                                                name="transferencia" id="transferencia" placeholder="Bolivianos Bs.">
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input autocomplete="off"
                                                class="form-control border-1 border-info bg-light shadow-sm" type="text"
                                                name="tarjeta" id="tarjeta" placeholder="Bolivianos Bs.">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <br>
                                            <h5>DEPOSITO Bs.</h5>
                                            <input autocomplete="off"
                                                class="form-control border-1 border-info bg-light shadow-sm" type="text"
                                                name="deposito" id="deposito" placeholder="Bolivianos Bs.">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <br><br>
                                        <a href="{{ route('productoAntiguo.create') }}"
                                            class="btn btn-success mb-2">Agregar Producto Antiguo</a>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <br>
                                        <h4 for="id_productoA">Seleccione Producto </h4>
                                        <select class="form-select border-warning form-select-lg mb-0"
                                            aria-label=".form-select-lg example" name="id_productoA" id="id_productoA"
                                            placeholder="">
                                            @foreach ($productosA as $productoA)
                                                <option value="{{ $productoA->id }}">
                                                    {{ $productoA->nombre }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group col-md-4">
                                        ...
                                        <input autocomplete="off"
                                            class="form-control border-1 border-info bg-light shadow-sm" type="text"
                                            name="precio" id="precio" placeholder="">
                                    </div>
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="staticBackdropLabel"><i
                                                    ...
                                                    class="bi bi-exclamation-lg"></i><i class="bi bi-exclamation-lg"></i><i
