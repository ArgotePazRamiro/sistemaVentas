                ...
                <div class="row">
                    ...
                    <div class="col-11 col-md-6">
                        <form action="{{ route('terminarOCancelarVenta') }}" method="POST">
                            ...
                            <h4 for="id_cliente" >CLIENTE <a href="{{ route('clientes.create')}}" class="btn btn-warning" ><i class="bi bi-person-plus-fill"></i></a></h4>
                                <select required class="form-select form-select-lg mb-0"
                                    aria-label=".form-select-lg example" name="id_cliente" id="id_cliente" placeholder="asdasd">
